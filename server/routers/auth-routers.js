...
router.get('/auth/twitter/callback', passport.authenticate('twitter', ({ failureRedirect: '/', successRedirect: '/dashboard' })))

// Github passport routers
// ===========================//
router.get('/auth/github', passport.authenticate('github'))
router.get('/auth/github/callback', passport.authenticate('github', ({ failureRedirect: '/', successRedirect: '/dashboard' })))
